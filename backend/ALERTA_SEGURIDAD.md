...
**⚠️ IMPORTANTE:** El secreto anterior `esunsecretoentumirada` está comprometido. Ya fue reemplazado.
...
⚠️ **ADVERTENCIA:** Esto reescribirá el historial de Git. Todos los colaboradores necesitarán clonar el repo de nuevo.
